 ...
 * @since 1.0.0
 */
class Company_Block extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Company Block', 'vervoer' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'company_block',
			[
				'label' => esc_html__( 'Company Block', 'vervoer' ),
			]
		);
		$this->add_control(
			'sec_class',
	...
	protected function render() {
		...
		<section class="service-details company <?php echo esc_attr($settings['sec_class']);?>">
			<div class="service-right-side">
				<div class="company-feature style-02">
