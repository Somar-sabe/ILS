...
class Newsletter extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Newsletter', 'vervoer' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'newsletter',
			[
				'label' => esc_html__( 'Newsletter', 'vervoer' ),
			]
		);
		$this->add_control(
			'contact_us_form',
	...
	protected function render() {
		...
		<section class="newsletter-popup <?php echo esc_attr($settings['sec_class']);?>">
			<div class="container">
