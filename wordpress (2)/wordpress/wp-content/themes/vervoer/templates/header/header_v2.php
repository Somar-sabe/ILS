        ...
        <div class="container"> 
            <div class="outer-box">
                ...
                <div class="header-right-button">
                    <a href="<?php echo wp_kses( $options->get( 'button_link_v1'), $allowed_html ); ?>" class="button-style-one"><i class="fa fa-paper-plane"></i><?php echo wp_kses( $options->get( 'button_v1'), $allowed_html ); ?></a>
                </div> 
				<?php endif; ?>
            </div>
        </div>
