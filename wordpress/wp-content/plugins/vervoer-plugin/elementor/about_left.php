...
class About_Left extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'About Left', 'vervoer' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'about_left',
			[
				'label' => esc_html__( 'About Left', 'vervoer' ),
			]
		);
		$this->add_control(
			'image',
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-12 col-lg-12">
						<div class="about-image-colmun mb_30 wow slideInLeft animated" data-wow-delay="00ms" data-wow-duration="1500ms">
							<div class="shape-01">
							...
							<div class="add-text"><i class="flaticon-tick-1"></i> <?php echo $settings['text'];?></div>
							<?php endif; ?>
							<?php if($settings['text1']): ?>
							<div class="add-text-two centred"><i class="flaticon-tick-1"></i><?php echo $settings['text1'];?></div>
							<?php endif; ?>
						</div>
					</div>
				</div>
