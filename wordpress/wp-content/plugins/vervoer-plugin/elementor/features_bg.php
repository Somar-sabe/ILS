 ...
 * @since 1.0.0
 */
class Features_Bg extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Features Bg', 'vervoer' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'features_bg',
			[
				'label' => esc_html__( 'Features Bg', 'vervoer' ),
			]
		);
		$this->add_control(
			'sec_class',
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-12 col-lg-12">
						...
						<div class="feature-banner mb_30 wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms" style="background-image: url(<?php echo wp_get_attachment_url($settings['bgimg']['id']);?>);">
						<?php else :?>	
						<div class="feature-banner mb_30 wow fadeInUp animated">
						<?php endif;?>
							...
							<div class="request-a-quote"><a href="<?php echo esc_url($settings['btnlink']['url']);?>" class="button-style-one"><i class="flaticon-document"></i> <?php echo $settings['bttn'];?></a></div>
							<?php endif; ?>
						</div>
					</div>
				</div>
