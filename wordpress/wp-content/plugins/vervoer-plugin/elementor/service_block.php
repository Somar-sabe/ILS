...
class Service_Block extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Service Block', 'vervoer' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'service_block',
			[
				'label' => esc_html__( 'Service Block', 'vervoer' ),
			]
		);
		$this->add_control(
			'sec_class',
	...
	protected function render() {
		...
		<!-- Service Section One -->
		<section class="service-001 <?php echo esc_attr($settings['sec_class']);?>">
			<div class="container">
				<div class="row">
					<div class="col-sm-12 colmun">
						<div class="service-block-001 mb_30 wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
							...
							<div class="service-inner" style="background-image: url(<?php echo wp_get_attachment_url($settings['bgimg']['id']);?>);">
							<?php else :?>	
							...
							<?php endif;?>
								...
								<div class="hidden-content">
									<div class="text-area">
										<h4><a href="<?php echo esc_url($settings['btnlink']['url']);?>"><?php echo $settings['title'];?></a></h4>
										<p><?php echo $settings['text'];?></p>
										<div class="link-button"><a href="<?php echo esc_url($settings['btnlink']['url']);?>"><i class="flaticon-right-arrow-1"></i></a></div>
									</div>
								</div>
							</div>
						</div>
