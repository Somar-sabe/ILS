 ...
 * @since 1.0.0
 */
class Service_Block3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Service Block Three', 'vervoer' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'service_block3',
			[
				'label' => esc_html__( 'Service Block Three', 'vervoer' ),
			]
		);
		$this->add_control(
			'sec_class',
